        ...
        <div className="overflow-hidden font-['Rye']">
            ...
            >
                <div className="w-full max-w-2xl flex flex-col items-center space-y-10 text-center">
                    <div className="w-[80%] p-6 rounded-xl bg-[#2a2118] border-4 border-[#c2a470] shadow-2xl ring-2 ring-[#796043] rotate-[-2deg]">
                        ...
                        <p className="text-xl md:text-2xl text-[#e6d3b3] italic">
                            "Ahol minden férfi és nő, legjobb stílusban távozik"
                        </p>
                        <Link
                            to="/szolgaltatasok"
