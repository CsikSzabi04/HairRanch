...
export default function Gallery() {
    ...
    return (
        <div className="overflow-hidden font-['Rye']">
            ...
            >
                {/* Banner */}
                <div className="w-[80%] flex justify-center" style={{ marginTop: "4%", marginLeft: "0%" }}>
                ...
                {/* Photos with drag-to-scroll */}
                <div 
                    ref={scrollContainerRef}
                    className="overflow-x-auto whitespace-nowrap scrollbar-hide w-[90%] mt-6 cursor-grab active:cursor-grabbing"
                ...
                >
                  ...
                  <div 
                    ...
                    onTouchMove={handleTouchMove}
                    onTouchEnd={handleMouseUp}
                    style={{ marginTop: "4%", marginBottom: "2%", marginLeft: "0%" }}
                >
                    <div className="flex gap-6 justify-center w-max mx-auto px-2">
